...
body: JSON.stringify({username: username, companyName: companyName})
    ...
    fetch('https://general-runtime.voiceflow.com/state/user/' + uniqueId + '/variables', options)
        ...
        .then(response => {
            ...
            return delay(1000);  // Delay for 1 second
        })
        .then(() => {
            // Here you put the code that you want to execute after the delay.
            // For example, the #launch# code or whatever action that follows.
        })
