// Check if chatWindow is defined, if not, define it
if (typeof chatWindow === 'undefined') {
    chatWindow = document.getElementById('chat-window');
}
// Check if assistantMessageElement is defined, if not, define it
if (typeof assistantMessageElement === 'undefined') {
...
// Check if buttons is defined, if not, define it as an empty array
