...
const transcriptOptions = {
  ...
  headers: {
    ...
    Authorization: 'VF.DM.64e73e4a83cd530007f72e6d.jST2BQpUtg8bSeKr'
  },
  body: JSON.stringify({
    versionID: 'production',
    sessionID: 'hn2W4OsZVUglUCu7AnYa',
    projectID: '64e73e4a83cd530007f72e69'
  })
};
  ...
  .catch(err => console.error(err));
    ...
    const options = {
        ...
        headers: {
            ...
            versionID: 'production',
            'content-type': 'application/json',
            Authorization: 'VF.DM.64e73e4a83cd530007f72e6d.jST2BQpUtg8bSeKr' // Consider securing this token
        },
        body: JSON.stringify({
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const voiceflowVersionID =
    ...
    'production'
  const voiceflowAPIKey = 'VF.DM.64e73e4a83cd530007f72e6d.jST2BQpUtg8bSeKr'
  let audio = new Audio()
