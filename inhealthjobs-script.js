...
const transcriptOptions = {
  ...
  headers: {
    ...
    Authorization: 'VF.DM.6526b4efa2faa30008aebefa.7ltZBZuqljILsqMz'
  },
  body: JSON.stringify({
    versionID: 'production',
    projectID: '65231f69ffcc370007a1300a'
  })
};
  ...
  .catch(err => console.error(err));
    ...
    const options = {
        ...
        headers: {
            ...
            versionID: 'production',
            'content-type': 'application/json',
            Authorization: 'VF.DM.6526b4efa2faa30008aebefa.7ltZBZuqljILsqMz' // Consider securing this token
        },
        body: JSON.stringify({
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const voiceflowVersionID =
    ...
    'production'
  const voiceflowAPIKey = 'VF.DM.6526b4efa2faa30008aebefa.7ltZBZuqljILsqMz'
  let audio = new Audio()
