// Define chatWindow if it's not defined
let chatWindow = chatWindow || document.getElementById('chat-window');
// Define assistantMessageElement if it's not defined
let assistantMessageElement = assistantMessageElement || document.createElement('div');
assistantMessageElement.classList.add('message', 'assistant');
// Append the assistant message to the chat window
chatWindow.appendChild(assistantMessageElement);
// Create a new div element for the buttons and append it to the chat window
const buttonsContainer = document.createElement('div');
buttonsContainer.classList.add('buttons-container');
// Define buttons if it's not defined
let buttons = buttons || [];
// Append each button to the buttons container
buttons.forEach((button) => {
    buttonsContainer.appendChild(button);
});
// Append the buttons container to the chat window
chatWindow.appendChild(buttonsContainer);const typingIndicator = document.getElementById('typing-indicator');
