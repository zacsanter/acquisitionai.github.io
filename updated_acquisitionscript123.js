...
// Select the hypothetical send icon by its ID
...
sendIcon.addEventListener('click', () => {
  ...
  if (userInput) {
    ...
    // You'll need to add the rest of the logic here that sends the message,
    // which should be similar to what happens after pressing the "Enter" key.
    // For example: 
    // interact(userInput);
  }
});
