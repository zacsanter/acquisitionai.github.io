...
function handleUserInput() {
  ...
  if (userInput) {
    ...
    // Additional actions to be performed after getting user input...
  }
}
...
const sendButton = document.getElementById('send-button'); // Assuming the button has an id of 'send-button'
